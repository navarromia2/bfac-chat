---
title: "02A_tab-1-pois-any-violence"
author: "Mia Navarro"
date: "2024-09-26"
output:
...
m1_pois_any <- create_pois_any(df_all)
m2_mal_pois_any <- create_pois_any(df_mal)
m2_pne_pois_any <- create_pois_any(df_pne)
m2_dia_pois_any <- create_pois_any(df_dia)

## glimpse of results
summary(m1_pois_any)
exp(summary(m1_pois_any)$coeff) #exponentiate to get IRR
